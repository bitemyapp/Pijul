...
$pijul record patch1 -a --author "William Morris" --name "patch1"
$pijul add file_to_leave_alone
$pijul record patch2 -a --author "Virginia Woolf" --name "patch2"
echo yn | $pijul unrecord
